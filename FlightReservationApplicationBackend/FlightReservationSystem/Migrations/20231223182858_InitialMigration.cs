        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Flights_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerFlights", x => new { x.CustomerId, x.FlightId });
                    table.ForeignKey(
                        name: "FK_CustomerFlights_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerFlights_Flights_FlightId",
                        column: x => x.FlightId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerFlights_FlightId",
